...
//the above program throws a syntax error. The spelling of console is a mistake in the above code.
...

{
    ...
    // // The main code is inside the try block. While executing the try block, 
    //if any error occurs, it goes to the catch block. The catch block handles the 
    //errors as per the catch statements.
}
